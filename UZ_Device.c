...
static void __exit saida(void){
    ...
    pr_info("Dispositivo %s removido.\n", DEVICE_NAME);
}
...
static int device_open(struct inode *inode, struct file *file){
    ...
    sprintf(msg, "Abertura nÂº %d - Bem-vindo ao dispositivo UZ_Device!\n", counter++);
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("RMI - Modificado por Estudante UNIZAMBEZE");
MODULE_DESCRIPTION("MÃ³dulo para leitura e escrita de um dispositivo em caractere UZ_Device");